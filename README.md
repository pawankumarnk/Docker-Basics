...
- Docker installed on your machine. Refer the official [installation document](https://docs.docker.com/engine/install/).
...
1. **Clone the repository**:
   ```sh
   git clone https://github.com/pawankumarnk/Docker-Basics.git -b python-code-deployment
   cd docker-basics
   ```
